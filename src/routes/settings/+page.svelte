...
<div class="space-y-8">
	...
	<div class="grid grid-cols-1 gap-4 md:grid-cols-2 stagger-children">
		...
		<a href="/settings/keywords" class="group glass-card p-6 transition-smooth hover:bg-bg-hover/30 btn-press card-hover">
			<div class="mb-4 flex h-12 w-12 items-center justify-center rounded-2xl bg-orange/12">
				<BookOpen size={22} class="text-orange" strokeWidth={1.8} />
			</div>
			<h2 class="text-[15px] font-semibold text-text-primary group-hover:text-orange transition-smooth">Dictionnaire mots-clés</h2>
			<p class="mt-1 text-[13px] text-text-muted">Mots-clés pour l'auto-catégorisation des transactions importées</p>
		</a>

		<a href="/settings/preferences" class="group glass-card p-6 transition-smooth hover:bg-bg-hover/30 btn-press card-hover">
			<div class="mb-4 flex h-12 w-12 items-center justify-center rounded-2xl bg-cyan/12">
				<SlidersHorizontal size={22} class="text-cyan" strokeWidth={1.8} />
			</div>
			<h2 class="text-[15px] font-semibold text-text-primary group-hover:text-cyan transition-smooth">Préférences</h2>
			<p class="mt-1 text-[13px] text-text-muted">Format de date, horizon prévisionnel, premier jour du mois</p>
		</a>
